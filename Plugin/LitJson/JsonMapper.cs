#region Header
    ...
    namespace LitJson
    {
        ...
        #region Fields
            ...
            private static readonly object                          custom_exporters_table_lock = new();

            private static readonly IDictionary<Type,
                IDictionary<Type, ImporterFunc>> base_importers_table;
            private static readonly IDictionary<Type,
                IDictionary<Type, ImporterFunc>> custom_importers_table;
            private static readonly object custom_importers_table_lock = new();
        ...
        #region Private Methods
            ...
            private static object ReadValue(Type inst_type, JsonReader reader)
            {
                    ...
                    reader.Token == JsonToken.Boolean)
                {
                    ...
                    lock (custom_importers_table_lock)
                    {
                        if (custom_importers_table.TryGetValue(json_type, out var customImporterTablesValue) &&
                            customImporterTablesValue.TryGetValue(value_type, out var customImporter))
                        {
                    ...
                    if (base_importers_table.TryGetValue(json_type, out var baseImporterTablesValue) &&
                        baseImporterTablesValue.TryGetValue(value_type, out var baseImporter))
                    {
