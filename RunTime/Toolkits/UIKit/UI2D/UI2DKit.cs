...
namespace Framework3.Toolkits.UIKit
{
    ...
    public class UI2DKit
    {
        ...
        {
            return LoadPanelAsync(typeof(T).Name, callback, level);
        }
        ...
        {
            return UI2DMgr.Instance.LoadPanelAsync(panelName, callback, level);
        }
        ...
        {
            return ShowPanelAsync(typeof(T).Name, callback, level);
        }
        ...
        {
            return UI2DMgr.Instance.ShowPanelAsync(panelName, callback, level);
        }
        ...
        {
            UI2DMgr.Instance.HidePanel(panelName, callback);
        }
        ...
        {
            TogglePanelAsync(typeof(T).Name, callback, level);
        }
