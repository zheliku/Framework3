...
namespace Framework3.Toolkits.FSMKit
{
    ...
    [HideReferenceObjectPicker] // Odin Inspector特性：隐藏引用对象选择器，简化编辑器界面
    ...
    #region 字段
        ...
        /// </summary>
        [ShowInInspector] // Odin Inspector特性：在编辑器中显示该私有字段
    ...
    #region 方法
        ...
        /// 4. 切换步骤：调用当前状态的<see cref="IState.Exit"/> → 记录上一状态ID → 更新当前状态 → 触发切换回调 → 重置状态时长统计 → 调用目标状态的<see cref="IState.Enter"/>
        /// </remarks>
