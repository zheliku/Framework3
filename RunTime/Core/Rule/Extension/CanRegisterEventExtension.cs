...
namespace Framework3.Core
{
    ...
    public static class CanRegisterEventExtension
    {
        ...
        {
            return self.Architecture.RegisterEvent(onEvent, priority); // 调用 Architecture 类的 RegisterEvent 方法
        }
        ...
        {
            self.Architecture.UnregisterEvent(onEvent); // 调用 Architecture 类的 UnregisterEvent 方法
        }
    }
}