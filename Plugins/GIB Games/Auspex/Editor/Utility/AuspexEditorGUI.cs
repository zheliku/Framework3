...
namespace GIB.Auspex.Editor
{
    public static class AuspexEditorGUI
    {
        ...
        public static void Button(UnityEngine.Object target, MethodInfo methodInfo)
        {
            ...
            if (methodInfo.GetParameters().All(p => p.IsOptional))
            {
                ...
                Color buttonColor = buttonAttribute.ButtonColor;
                ButtonSizes buttonSize = buttonAttribute.ButtonSize;

                bool buttonEnabled = ButtonUtility.IsEnabled(target, methodInfo);

                ButtonMode mode = buttonAttribute.SelectedEnableMode;
                buttonEnabled &=
                    mode == ButtonMode.AlwaysEnable ||
                    mode == ButtonMode.EditorOnly && !Application.isPlaying ||
                    mode == ButtonMode.PlaymodeOnly && Application.isPlaying;
                ...
                if (GUILayout.Button(buttonText, _buttonStyle, GUILayout.Height(targetButtonSize)))
                {
