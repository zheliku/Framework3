...
namespace GIB.Auspex.Editor
{
    public abstract class PropertyDrawerBase : PropertyDrawer
    {
        ...
        {
            float indentLength = AuspexEditorGUI.GetIndentLength(rect);
            ...
            AuspexEditorGUI.HelpBox(helpBoxRect, message, MessageType.Warning, context: property.serializedObject.targetObject);
