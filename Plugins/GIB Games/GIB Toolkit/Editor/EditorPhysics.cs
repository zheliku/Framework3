...
namespace GIB.EditorUtilities
{
    ...
    public class EditorPhysics : EditorWindow
    {
        ...
        [MenuItem("Tools/GIB Toolkit/Physics Simulation", false, -100)]
        private static void CreateInstance()
        {
            GetWindow(typeof(EditorPhysics), false, "Physics Simulator");
        }
        #endregion
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField(
                "This tool simulates physics in editor to aid in level design.",
        ...
        class HoldRigidbody : IEquatable<Rigidbody>
        {
            ...
            public void Revert()
            {
                ...
                // This throws an error since 2022.1
