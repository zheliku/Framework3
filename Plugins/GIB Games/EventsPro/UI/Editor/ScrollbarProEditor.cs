...
{
    [CustomEditor(typeof(ScrollbarPro), true)]
    [CanEditMultipleObjects]
    public class ScrollbarProEditor : SelectableEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_HandleRect.objectReferenceValue != null)
            {
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    ScrollbarPro.Direction direction = (ScrollbarPro.Direction)m_Direction.enumValueIndex;
                    foreach (var obj in serializedObject.targetObjects)
                    {
                        ScrollbarPro scrollbar = obj as ScrollbarPro;
                ...
                {
                    ScrollbarPro scrollbar = obj as ScrollbarPro;
                    ScrollbarPro.Direction dir = scrollbar.direction;
                    if (dir == ScrollbarPro.Direction.LeftToRight || dir == ScrollbarPro.Direction.RightToLeft)
