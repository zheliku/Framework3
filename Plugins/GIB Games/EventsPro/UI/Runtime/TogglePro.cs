...
namespace UnityEngine.UI
{
	...
	/// </summary>
	[AddComponentMenu("UI/Toggle Pro", 31)]
	[RequireComponent(typeof(RectTransform))]
	public class TogglePro : Selectable, IPointerClickHandler, ISubmitHandler, ICanvasElement
	{
		[Serializable]
		public class ToggleProEvent : EventPro<bool> { }
		...
		[SerializeField]
		private ToggleGroupPro m_Group;

		public ToggleGroupPro group
		{
			get { return m_Group; }
			set
			{
		...
		public ToggleProEvent onValueChanged = new ToggleProEvent();
		...
		private void SetToggleGroup(ToggleGroupPro newGroup, bool setMemberValue)
		{
			ToggleGroupPro oldGroup = m_Group;
