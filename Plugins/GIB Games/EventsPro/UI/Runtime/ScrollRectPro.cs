...
namespace UnityEngine.UI
{
	...
	/// </remarks>
	[AddComponentMenu("UI/Scroll Rect Pro", 38)]
	[SelectionBase]
	[ExecuteInEditMode]
	...
	{
		[Serializable]
		public class ScrollRectProEvent : EventPro<Vector2> { }
		...
		[SerializeField]
		private ScrollbarPro m_HorizontalScrollbar;
		public ScrollbarPro horizontalScrollbar
		{
			get
			{
		...
		[SerializeField]
		private ScrollbarPro m_VerticalScrollbar;
		public ScrollbarPro verticalScrollbar
		{
			get
			{
		...
		private ScrollRectProEvent m_OnValueChanged = new ScrollRectProEvent();
		public ScrollRectProEvent onValueChanged { get { return m_OnValueChanged; } set { m_OnValueChanged = value; } }
		...
		private static void UpdateOneScrollbarVisibility(bool xScrollingNeeded, bool xAxisEnabled, ScrollRect.ScrollbarVisibility scrollbarVisibility, ScrollbarPro scrollbar)
		{
			if (scrollbar)
			{
