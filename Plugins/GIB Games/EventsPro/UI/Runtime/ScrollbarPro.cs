...
{
	[AddComponentMenu("UI/Scrollbar Pro", 34)]
	[ExecuteAlways]
	...
	/// </remarks>
	public class ScrollbarPro : Selectable, IBeginDragHandler, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
	{
		/// <summary>
		...
		[Serializable]
		/// <summary>
		/// EventPro callback for when a scrollbar is scrolled.
		/// </summary>
		public class ScrollEventPro : EventPro<float> { }
		...
		/// </summary>
		public Direction direction { get { return m_Direction; } set { if (EP_SetPropertyUtility.SetStruct(ref m_Direction, value)) UpdateVisuals(); } }
		...
		/// </summary>
		public float size { get { return m_Size; } set { if (EP_SetPropertyUtility.SetStruct(ref m_Size, Mathf.Clamp01(value))) UpdateVisuals(); } }

		[Range(0, 11)]
		[SerializeField]
		[Tooltip("The number of steps to use for the value. A value of 0 disables use of steps.")]
		private int m_NumberOfSteps = 0;

		/// <summary>
		/// The number of steps to use for the value. A value of 0 disables use of steps.
		/// </summary>
		public int numberOfSteps { get { return m_NumberOfSteps; } set { if (EP_SetPropertyUtility.SetStruct(ref m_NumberOfSteps, value)) { Set(m_Value); UpdateVisuals(); } } }

		[Space(6)]

		[SerializeField]
		[Tooltip("Events to trigger when this scrollbar value is changed")]
		private ScrollEventPro m_OnValueChanged = new ScrollEventPro();
		...
		/// </remarks>
		public ScrollEventPro onValueChanged { get { return m_OnValueChanged; } set { m_OnValueChanged = value; } }
