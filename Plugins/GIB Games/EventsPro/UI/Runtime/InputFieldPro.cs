...
namespace UnityEngine.UI
{
	...
	[AddComponentMenu("UI/Input Field Pro", 32)]
	public class InputFieldPro: Selectable, IUpdateSelectedHandler, IBeginDragHandler,
		IDragHandler, IEndDragHandler, IPointerClickHandler,ISubmitHandler, ICanvasElement, ILayoutElement
	{
		public delegate char OnValidateInput(string text, int charIndex, char addedChar);

		[Serializable]
		/// <summary>
		///   Event Pro with a inputfield as a param.
		/// </summary>
		public class EP_SubmitEvent : EventPro<string> { }

		[Serializable]
		/// <summary>
		/// The callback sent anytime the Inputfield is updated.
		/// </summary>
		public class EP_OnChangeEvent : EventPro<string> { }

		protected TouchScreenKeyboard m_Keyboard;
		static private readonly char[] kSeparators = { ' ', '.', ',', '\t', '\r', '\n' };

		[Tooltip("Keyboard type applies to mobile keyboards that get shown.")]
		[SerializeField]
		protected Text m_TextComponent;

		/// <summary>
		/// The current active clipboard text from the system buffer.
		/// </summary>
        ...
        public Text textComponent
        {
            ...
            set
            {
                ...
                if (EP_SetPropertyUtility.SetClass(ref m_TextComponent, value))
                {
		...
		/// </summary>
		public Graphic placeholder { get => m_Placeholder; set { EP_SetPropertyUtility.SetClass(ref m_Placeholder, value); } }
		...
		/// <summary>
		/// Specifies the <see cref="InputField.ContentType">Content Type</see> of the input content.
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public InputField.ContentType contentType { get => m_ContentType; set { if (EP_SetPropertyUtility.SetStruct(ref m_ContentType, value)) EnforceContentType(); } }
        ...
        [SerializeField]
		[Tooltip("The type of input expected.")]
		private InputField.InputType m_InputType = InputField.InputType.Standard;
		/// <summary>
		/// The expected <see cref="InputField.InputType">Input Type</see> of the InputField.
		/// </summary>
		public InputField.InputType inputType { get { return m_InputType; } set { if (EP_SetPropertyUtility.SetStruct(ref m_InputType, value)) SetToCustom(); } }
		...
		/// </summary>
		public char asteriskChar { get => m_asteriskChar; set { if (EP_SetPropertyUtility.SetStruct(ref m_asteriskChar, value)) UpdateLabel(); } }
		...
		public TouchScreenKeyboardType keyboardType
        {
            ...
            set
            {
                if (EP_SetPropertyUtility.SetStruct(ref m_KeyboardType, value))
                    SetToCustom();
            }
        }
		...
		/// <summary>
		/// The <see cref="InputField.LineType">LineType</see> used by the InputField.
		/// </summary>
		public InputField.LineType lineType
        {
            ...
            set
            {
                if (EP_SetPropertyUtility.SetStruct(ref m_LineType, value))
                {
        ...
        /// </summary>
        public bool multiLine => m_LineType == InputField.LineType.MultiLineNewline || lineType == InputField.LineType.MultiLineSubmit;

        /// <summary>
        /// Should hide mobile input.
        /// </summary>
        [SerializeField]
		[Tooltip("Should hide mobile input.")]
		private bool m_HideMobileInput = false;

		[SerializeField]
		[Tooltip("What kind of validation to use with the input field's data.")]
		private InputField.CharacterValidation m_CharacterValidation = InputField.CharacterValidation.None;
		/// <summary>
		/// What kind of <see cref="InputField.CharacterValidation">CharacterValidation</see> to use with the input field's data.
		/// </summary>
		public InputField.CharacterValidation characterValidation { get { return m_CharacterValidation; } set { if (EP_SetPropertyUtility.SetStruct(ref m_CharacterValidation, value)) SetToCustom(); } }

		[SerializeField]
        [Tooltip("Maximum number of characters allowed before input no longer works.")]
        private int m_CharacterLimit = 0;
		/// <summary>
		/// Maximum number of characters allowed before input no longer works.
		/// </summary>
		public int characterLimit { get => m_CharacterLimit; set { if (EP_SetPropertyUtility.SetStruct(ref m_CharacterLimit, Math.Max(0, value))) UpdateLabel(); } }

        [SerializeField]
		[Tooltip("Events to trigger when user is done editing the field")]
		private EP_SubmitEvent m_OnEndEdit = new EP_SubmitEvent();
		/// <summary>
		/// Event delegates triggered when the input field change has ended.
		/// </summary>
		public EP_SubmitEvent onEndEdit { get => m_OnEndEdit; set { EP_SetPropertyUtility.SetClass(ref m_OnEndEdit, value); } }

        [SerializeField]
		[Tooltip("Events to trigger when this input field value is changed")]
		private EP_OnChangeEvent m_OnValueChanged = new EP_OnChangeEvent();
		/// <summary>
		/// Event delegates triggered when the input field changes its data.
		/// </summary>
		public EP_OnChangeEvent onValueChanged { get { return m_OnValueChanged; } set { EP_SetPropertyUtility.SetClass(ref m_OnValueChanged, value); } }


		[SerializeField]
		[Tooltip("Custom validation callback.")]
		private OnValidateInput m_OnValidateInput;
		/// <summary>
		/// Custom validation callback.
		/// </summary>
		public OnValidateInput onValidateInput { get => m_OnValidateInput; set { EP_SetPropertyUtility.SetClass(ref m_OnValidateInput, value); } }


        [SerializeField]
		[Tooltip("Whether a custom caret color should be used. If false, the text Component color will be used.")]
		private bool m_CustomCaretColor = false;
		/// <summary>
		/// Whether a custom caret color should be used. If false, the text Component color will be used.
		/// </summary>
		public bool customCaretColor { get => m_CustomCaretColor; set { if (m_CustomCaretColor != value) { m_CustomCaretColor = value; MarkGeometryAsDirty(); } } }

        [SerializeField]
		[Tooltip("The custom caret color used if Custom Color is set.")]
		private Color m_CaretColor = new Color(50f / 255f, 50f / 255f, 50f / 255f, 1f);
		/// <summary>
		/// The custom caret color used if <see cref="customCaretColor"/> is set.
		/// </summary>
		public Color caretColor { get => customCaretColor ? m_CaretColor : textComponent.color; set { if (EP_SetPropertyUtility.SetColor(ref m_CaretColor, value)) MarkGeometryAsDirty(); } }
		...
		/// </summary>
		/// <remarks>defaults to RGBA(168,206,255,192) (#A8CEFF)</remarks>
		public Color selectionColor { get => m_SelectionColor; set { if (EP_SetPropertyUtility.SetColor(ref m_SelectionColor, value)) MarkGeometryAsDirty(); } }
        /// <summary>
        /// Input field's value.
        /// </summary>

        [SerializeField]
		[Tooltip("Input field's current text value.")]
		...
		/// </remarks>
		public string text { get => m_Text; set { SetText(value); } }

        [SerializeField]
		[Range(0f, 4f)]
		[Tooltip("Number of times the blink cycle occurs per second.")]
		...
		public float caretBlinkRate
		{
			...
			set
			{
				if (EP_SetPropertyUtility.SetStruct(ref m_CaretBlinkRate, value))
				{
					if (m_AllowInput)
						SetCaretActive();
				}
		...
		/// </summary>
		public int caretWidth { get => m_CaretWidth; set { if (EP_SetPropertyUtility.SetStruct(ref m_CaretWidth, value)) MarkGeometryAsDirty(); } }


		[SerializeField]
		[Tooltip("Set the InputField to be read only.")]
		...
		/// </summary>
		/// <remarks>Getters are public; Setters are protected.</remarks>
		protected int caretPositionInternal { get => m_CaretPosition + compositionString.Length; set { m_CaretPosition = value; ClampPos(ref m_CaretPosition); } }
		/// <summary>
		...
		{
			get => m_CaretPosition + compositionString.Length;
			set
			{
		...
		{
			get => m_CaretSelectPosition + compositionString.Length;
			set
			{
				if (compositionString.Length != 0)
					return;
		...
		protected int caretSelectPositionInternal { get => m_CaretSelectPosition + compositionString.Length; set { m_CaretSelectPosition = value; ClampPos(ref m_CaretSelectPosition); } }
        ...
        protected InputFieldPro() => EnforceTextHOverflow();
		...
		public bool shouldHideMobileInput
        {
            ...
            set => EP_SetPropertyUtility.SetStruct(ref m_HideMobileInput, value);
        }
        ...
        {
            get => Application.platform != RuntimePlatform.tvOS;
		...
		/// <summary>
		/// Update the TouchKeyboard's text from edit changes if in-place editing is allowed.
		/// </summary>
		...
		{
			UISystemProfilerApi.AddMarker("InputFieldPro.value", this);
		...
		{
			UISystemProfilerApi.AddMarker("InputFieldPro.onSubmit", this);
			if (onEndEdit != null)
		...
		/// <summary>
		/// See <see cref="ICanvasElement.LayoutComplete"/>. Does nothing by default.
		/// </summary>
		public virtual void LayoutComplete() { }

		/// <summary>
		/// See <see cref="ICanvasElement.GraphicUpdateComplete"/>. Does nothing by default.
		/// </summary>
		...
		protected char Validate(string text, int pos, char ch)
		{
			...
			if (characterValidation == InputField.CharacterValidation.Integer || characterValidation == InputField.CharacterValidation.Decimal)
			{
				...
				if (!cursorBeforeDash || dashInSelection)
				{
					...
					if ((ch == '.' || ch == ',') && characterValidation == InputField.CharacterValidation.Decimal && !text.Contains(".")) return ch;
				}
			}
		...
		private void ActivateInputFieldInternal()
		{
			...
			if (TouchScreenKeyboard.isSupported)
			{
				...
				m_Keyboard = (inputType == InputField.InputType.Password) ?
					...
					TouchScreenKeyboard.Open(m_Text, keyboardType, inputType == InputField.InputType.AutoCorrect, multiLine, false, false, "", characterLimit);
		...
		/// <summary>
		/// See <see cref="ILayoutElement.CalculateLayoutInputHorizontal"/>. Does nothing by default.
		/// </summary>
		public virtual void CalculateLayoutInputHorizontal() { }
		/// <summary>
		/// See <see cref="ILayoutElement.CalculateLayoutInputVertical"/>. Does nothing by default.
		/// </summary>
		public virtual void CalculateLayoutInputVertical() { }
		/// <summary>
		/// See <see cref="ILayoutElement.minWidth"/>.
		/// </summary>
		/// <returns>0</returns>
		...
		/// <summary>
		/// See <see cref="ILayoutElement.flexibleWidth"/>.
		/// </summary>
		/// <returns>-1</returns>
		public virtual float flexibleWidth { get { return -1; } }
		/// <summary>
		/// See <see cref="ILayoutElement.minHeight"/>.
		/// </summary>
		/// <returns>0</returns>
		...
		/// <summary>
		/// See <see cref="ILayoutElement.flexibleHeight"/>.
		/// </summary>
		/// <returns>-1</returns>
		public virtual float flexibleHeight { get { return -1; } }
		/// <summary>
		/// See <see cref="ILayoutElement.layoutPriority"/>.
		/// </summary>
		/// <returns>1</returns>
